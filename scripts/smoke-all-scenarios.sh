...
scenarios=(closed sessionList approvalCard questionCard codexQuestionCard completionCard longCompletionCard)
...
for scenario in approvalCard codexQuestionCard completionCard; do
